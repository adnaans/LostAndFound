        ...
        firebasenode.once('value', function(snapshot) {
          ...
          if(snapshot!="{}"){
            ...
            snapshot.forEach(function(snap){
                ...
                $('#item'+i).html("<td align = 'center'><p>"+snap.val().name+"<td align = 'center'><img id='code' src = 'https://api.qrserver.com/v1/create-qr-code/?size=75x75&data=found.html?uid="+snap.key+"' alt = '...'></img></td><td><p>"+loc+"</p></td><td><p>"+time+"</p></td>");
                i++;
              }
            );
          }
